...
export const legendData = {
  ...
  'Hidalgo:01_precipitacion': {
    ...
    items: [
      { value: 350, color: '#a7d6f1ff', label: 'Menor a 350 mm/año' },
      { value: 500, color: '#4c8eb9ff', label: '350 - 500 mm/año' },
      { value: 850, color: '#2171b5', label: '500 - 850 mm/año' },
      { value: Infinity, color: '#08306b', label: 'Mayor a 850 mm/año' }
    ]
  },
  ...
  'Hidalgo:01_sbsitios': {
    title: 'Sitios de Monitoreo',
    type: 'point',
    items: [{ color: COLORS.WATER, label: 'Subterráneos' }]
  },
  'Hidalgo:01_sbcalidadagua': {
    title: 'Parámetros (Subterránea)',
